...
/*   Updated: 2025/01/24 15:43:39 by zadriouc@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define TEXTURE_CLRS_CNT 2
#define TEXTURE_DIRECTION_KEY_LENGHT 2
#define TEXTURE_COLOR_LENGTH 1
...
typedef enum texture_direction
{
    TEXTURE_DIRECTION_NO,
    TEXTURE_DIRECTION_SO,
    TEXTURE_DIRECTION_EA,
    TEXTURE_DIRECTION_WE,
    TEXTURE_DIRECTION_UNKOWN = -1,
}           t_tdir;

typedef enum texture_color
{
	TEXTURE_COLOR_F,
	TEXTURE_COLOR_C,
	TEXTURE_COLOR_UNKOWN = -1,
}			t_tcol;
